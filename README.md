...
My strongest work spans Python and TypeScript platforms, Rust systems software, Linux operations,
and the control planes around AI agents. Client and organization source stays private; public
repositories are selected proof, not a mirror of every production system.
...
- [Rylus](https://github.com/revoydotdev/rylus) — attributed Weylus modernization into a modular,
  security-hardened pure-Rust screen and input streaming system.
